    ...
    <div className="flex justify-between pl-4 pr-4 pt-2 border border-b-slate-400 pb-3 font-mono">
      ...
      <div className="flex items-center justify-between gap-3">
        ...
        <div className="hidden lg:flex lg:items-center">
          <img src="src/assets/blackQuestion.svg" alt="" className="w-4" />
          <p>How it works</p>
        </div>
      </div>
...
{/* Icons Section */}
      <div className="hidden sm:flex sm:items-center sm:gap-2">
        <span className="bg-slate-300 p-2 rounded-full cursor-pointer">
            <img src="src/assets/message.svg" alt="" className="w-6"/>
        </span>

        <span className="bg-slate-300 p-2 rounded-full cursor-pointer">
            <img src="src/assets/DownArrow.svg" alt="" className="w-6"/>
        </span>
      </div>
    </div>
  );
